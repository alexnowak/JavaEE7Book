...
public class BookIT {
    ...
    private static EntityManagerFactory emf = Persistence.createEntityManagerFactory("BookTestPU");
	...
	Book book = new Book("H2G2", 22.5F, "The Hitchhiker's Guide to the Galaxy", 354, false);
	...
	Book book = new Book(null, 42.5F, "Null title, should fail", 354, false);
	em.persist(book);
    }
}
